...
let faveColors = ["purple", "violet", "turquoise"];
...
let me = {
	firstName: "Aster",
	superHeroName: "Dark Frost",
	homeTown: "Columbus",
	superPowers: ["ice magic", "environmental teleportation", "demonic technology"],
	superPowerXP: function(){
		let num = Math.floor((Math.random() * 100) + 1);
		return num},
	profileImage: function() {
		let num = Math.floor(Math.random() * 10) + 1;
		let imgUrl = `https://randomuser.me/api/portraits/med/lego/${num}.jpg`
		return imgUrl;
	}
}
